...
class X509
{
    ...
    function __construct()
    {
        ...
        $RDNSequence = array('type' => ASN1::TYPE_SEQUENCE, 'min' => 0, 'max' => -1, 'children' => $this->RelativeDistinguishedName);
        ...
        $this->Extensions = array('type' => ASN1::TYPE_SEQUENCE, 'min' => 1, 'max' => -1, 'children' => $Extension);
        ...
        $OrganizationalUnitNames = array('type' => ASN1::TYPE_SEQUENCE, 'min' => 1, 'max' => 4, 'children' => array('type' => ASN1::TYPE_PRINTABLE_STRING));
        ...
        $AdministrationDomainName = array('type' => ASN1::TYPE_CHOICE, 'class' => ASN1::CLASS_APPLICATION, 'cast' => 2, 'children' => array('numeric' => array('type' => ASN1::TYPE_NUMERIC_STRING), 'printable' => array('type' => ASN1::TYPE_PRINTABLE_STRING)));
        $CountryName = array('type' => ASN1::TYPE_CHOICE, 'class' => ASN1::CLASS_APPLICATION, 'cast' => 1, 'children' => array('x121-dcc-code' => array('type' => ASN1::TYPE_NUMERIC_STRING), 'iso-3166-alpha2-code' => array('type' => ASN1::TYPE_PRINTABLE_STRING)));
        ...
        $ExtensionAttributes = array('type' => ASN1::TYPE_SET, 'min' => 1, 'max' => 256, 'children' => $ExtensionAttribute);
        ...
        $BuiltInDomainDefinedAttributes = array('type' => ASN1::TYPE_SEQUENCE, 'min' => 1, 'max' => 4, 'children' => $BuiltInDomainDefinedAttribute);
        ...
        $EDIPartyName = array('type' => ASN1::TYPE_SEQUENCE, 'children' => array('nameAssigner' => array('constant' => 0, 'optional' => true, 'implicit' => true) + $this->DirectoryString, 'partyName' => array('constant' => 1, 'optional' => true, 'implicit' => true) + $this->DirectoryString));
        ...
        $this->CRLReason = array('type' => ASN1::TYPE_ENUMERATED, 'mapping' => array('unspecified', 'keyCompromise', 'cACompromise', 'affiliationChanged', 'superseded', 'cessationOfOperation', 'certificateHold', 8 => 'removeFromCRL', 'privilegeWithdrawn', 'aACompromise'));
    ...
    function signSPKAC($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($this->currentCert) && is_array($this->currentCert) && isset($this->currentCert['publicKeyAndChallenge'])) {
            ...
            $this->currentCert = array('publicKeyAndChallenge' => array('spki' => $publicKey, 'challenge' => !empty($this->challenge) ? $this->challenge : ''), 'signatureAlgorithm' => array('algorithm' => $signatureAlgorithm), 'signature' => false);
        }
    ...
    function signCRL($issuer, $crl, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($crl->currentCert) && is_array($crl->currentCert) && isset($crl->currentCert['tbsCertList'])) {
            ...
            $this->currentCert = array('tbsCertList' => array('version' => 'v2', 'signature' => array('algorithm' => $signatureAlgorithm), 'issuer' => false, 'thisUpdate' => $this->_timeField($thisUpdate)), 'signatureAlgorithm' => array('algorithm' => $signatureAlgorithm), 'signature' => false);
        }
