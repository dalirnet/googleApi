...
class SSH2
{
    ...
    {
        $kex_algorithms = array('curve25519-sha256@libssh.org', 'diffie-hellman-group1-sha1', 'diffie-hellman-group14-sha1', 'diffie-hellman-group-exchange-sha1', 'diffie-hellman-group-exchange-sha256',);
        if (!function_exists('\\Sodium\\library_version_major')) {
